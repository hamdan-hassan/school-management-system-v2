...
const AllInActiveStudents = () => {
  useEffect(() => {
    axios
      .get(`${baseUrl.baseUrl}/get-in-active-students`, {
        headers: {
  ...
  const filter = () => {
    axios
      .post(
        `${baseUrl.baseUrl}/get-teacher-in-active-students`,
  ...
  const handleConfirmActivate = () => {
    axios
      .put(
        `${baseUrl.baseUrl}/activate-student`,
        {
          Id: studentId,
        },
        {
        ...
        <div className="row">
          ...
          <div className="col-lg-6 col-md-6 col-sm-6 col-12">
            <ul className="breadcrumb float-right p-0 mb-0">
              ...
              <li className="breadcrumb-item">
                {" "}
                <span> All In-Active Students</span>
              </li>
            </ul>
          </div>
        </div>
...
export default AllInActiveStudents;
